...
alias saytimehourly="defaults write com.apple.speech.synthesis.general.prefs TimeAnnouncementPrefs -dict-add TimeAnnouncementsInterval -int 2;killall SystemUIServer"
...
# Eza: https://eza.rocks/
command_exists eza && alias ls="eza -a --no-user --no-time --long"
...
alias gl="git log --pretty=format:'%C(magenta)%h%Creset%C(auto)%d%Creset %s %C(blue bold)— %cr ~ %an%Creset'"
alias gpu="push"
